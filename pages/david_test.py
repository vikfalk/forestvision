...
send_orginal_images = st.radio('Send original images', ('False', 'True'))
backend_api_mode = st.radio('Backend API Mode', ('Local', 'Cloud'))
...
if st.button("Send Request"):
    ...
    st.write("Click the button to make a request.")
